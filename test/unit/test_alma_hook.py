...
# from mokelumne.providers.alma.hooks.alma import AlmaHook, _extract_language_codes
...
def test_get_marc_language_codes_from_fixture():
    """Verify language code extraction against a real Alma SRU fixture response."""
    ...
    codes = hook.get_marc_language_codes("991073999959706532")
